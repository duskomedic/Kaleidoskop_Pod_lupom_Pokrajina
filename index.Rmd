...
POKRAJINSKI SEKRETARIJAT ZA KULTURU I INFORMISANJE za oblast AKTUELNA KULTURNA PRODUKCIJA odobrio je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine.
<br>
<br>
...
POKRAJINSKI SEKRETARIJAT ZA KULTURU I INFORMISANJE za oblast MANIFESTACIJE odobrio je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine.
<br>
<br>
...
POKRAJINSKI SEKRETARIJAT ZA KULTURU I INFORMISANJE za oblast KULTURNA BAŠTINA odobrio je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine.
<br>
<br>
...
```
POKRAJINSKI SEKRETARIJAT ZA KULTURU I INFORMISANJE za oblast OBRAZOVANJE odobrio je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine.
<br>
<br>
...
POKRAJINSKI SEKRETARIJAT ZA KULTURU I INFORMISANJE za oblast FILMSKO STVARALAŠTVO odobrio je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine.
<br>
<br>
U ovoj oblasti najviše sredstava odobreni su projektima sledećih naziva: <br> •  <b>`r paste(Imena, SUMAMedija,  sep = " - ", collapse = " evra <br> • ")`</b> evra. 
<br>
...
POKRAJINSKI SEKRETARIJAT ZA KULTURU I INFORMISANJE za oblast MULTIKULTURALNOST odobrio je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine.
<br>
<br>
U ovoj oblasti najviše sredstava odobreni su projektima sledećih naziva: <br> •  <b>`r paste(Imena, SUMAMedija,  sep = " - ", collapse = " evra <br> • ")`</b> evra. 
<br>
...
<!-- POKRAJINSKI SEKRETARIJAT ZA KULTURU I INFORMISANJE za oblast VIZEULNO STVARALAŠTVO odobrio je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine. -->
<!-- <br> -->
<!-- <br> -->
<!-- U ovoj oblasti najviše sredstava odobreni su projektima sledećih naziva: <br> •  <b>`r paste(Imena, SUMAMedija,  sep = " - ", collapse = " evra <br> • ")`</b> evra.  -->
<!-- <br> -->
